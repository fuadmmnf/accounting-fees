...
class DefaultFeeSeeder extends Seeder
{
    public function run()
    {
        ...
        $defaults = [
            ['p_1', 't_100', 't_240', 'p_1.5', 'p_3', 'p_2', 't_360', '', '', ''],
            ['t_100', 't_100', 't_240', 't_200', '', '', 't_360', '', '', ''],
            ['t_100', 't_100', 't_240', 't_200', '', '', 't_360', '', '', ''],
            ['p_1', 't_100', 't_240', 'p_1.5', 'p_3', '', 't_360', '', '', ''],
            ['p_1', 't_100', 't_240', 't_200', 'p_3', '', 't_360', '', '', ''],
            ['t_100', 't_100', 't_240', 't_200', '', '', 't_360', '', '', ''],
            ['t_100', 't_100', 't_240', 't_200', '', '', 't_360', '', '', ''],
            ['t_100', 't_100', 't_240', 't_1000', '', '', 't_360', '', '', ''],
            ['t_100', 't_100', 't_240', 't_1000', '', '', 't_360', '', '', ''],
            ['t_500', 't_100', 't_240', 't_300', '', '', 't_360', '', '', ''],
            ['t_500', 't_100', 't_240', 't_50', '', '', 't_360', '', '', ''],
        ];
